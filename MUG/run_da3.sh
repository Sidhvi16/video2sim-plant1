...
#
#  Working directory: ~/cup1/
#  Frames:  ~/cup1/data/input/custom/plant/images/
#  Output:  ~/cup1/data/input/custom/plant/transforms.json
#
#  Pre-requisites:
...
FRAME_COUNT=$(ls ~/cup1/data/input/custom/plant/images/ | wc -l)
...
mkdir -p ~/cup1/data/output/custom/plant/da3_out
mkdir -p ~/cup1/data/cache/da3
...
export HF_HOME=/home/crajashekhar/cup1/data/cache/da3
...
/home/crajashekhar/.conda/envs/da3_env/bin/python3 /home/crajashekhar/cup1/repo/modules/da3/da3_process.py
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  ~/cup1/data/input/custom/plant/transforms.json"
else
